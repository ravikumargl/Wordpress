            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="sup_pagetitle sup_toppadder90 sup_bottompadder90">
                        <h2><?php printf( esc_html__( 'Search Results for: %s', 'speedup' ), get_search_query() ); ?></h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    ...
                    <?php 
                        ...
                        <?php
                                ...
                                '<p>'. esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'speedup' ).'</p>';
                                get_search_form(); 
                            ?>
                            </div>
                        </div>
