            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="sup_pagetitle sup_toppadder90 sup_bottompadder90">
                        <h2><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'speedup' ), get_the_date() );

                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'speedup' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'speedup' ) ) );

                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'speedup' ), get_the_date( _x( 'Y', 'yearly archives date format', 'speedup' ) ) );

                        else :
                            esc_html_e( 'Archives', 'speedup' );
